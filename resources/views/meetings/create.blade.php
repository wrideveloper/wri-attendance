        ...
        <div class="col-md-12">
            ...
            <form class="update-jadwal form rounded p-5" action="{{ route('meetings.store') }}" method="POST">
                ...
                <div class="form-group mb-md-5 mb-4">
                    ...
                    <input value="{{ old('topik') }}" type="text" class="form-control @error('topik') is-invalid @enderror" placeholder="Input Your Text in here" name="topik">
                    @error('topik')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                    @enderror
                    <input value="{{ Auth::user()->miniclass_id }}" type="hidden" class="form-control" name="miniclass_id">
                </div>
                    ...
                    <div class="col-12 px-0">
                        <div class="row">
                            <div class="form-group mb-md-2 mb-1 col-lg-9 col-md-6 col-12">
                                ...
                                <input value="{{ old('tanggal') }}" type="date" class="form-control" placeholder="YYYY/MM/DD" name="tanggal">
                                @error('tanggal')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mb-md-2 mb-1 col-lg-3 col-md-6 col-12">
                                ...
                                <input value="{{ old('pertemuan') }}" type="number" class="form-control" placeholder="Ke" name="pertemuan">
                                @error('pertemuan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <div class="col-12 px-0">
                    <div class="row">
                        <div class="form-group mb-md-5 mb-4 col-lg-4 col-md-6 col-12">
                            ...
                            <input value="{{ old('start_time') }}" type="time" class="@error('start_time') is-invalid @enderror form-control" placeholder="Input Your Text in here" name="start_time">
                            @error('start_time')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group mb-md-5 mb-4 col-lg-4 col-md-6 col-12">
                            ...
                            <input value="{{ old('end_time') }}" type="time" class="@error('end_time') is-invalid @enderror form-control" placeholder="Input Your Text in here" name="end_time">
                            @error('end_time')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group mb-md-5 mb-4 col-lg-4 col-md-12 col-12">
                            ...
                            <input value="{{ old('token') }}" type="text" class="@error('token') is-invalid @enderror form-control" placeholder="Input Your Text in here" name="token">
                            @error('token')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
