                <a class="list-group-item d-inline-block text-truncate {{ $title === 'Dashboard' ? 'active' : '' }}"
                    href="{{ url('dashboard') }}">
                    <i class="fa-solid fa-border-all" style="padding-right: 12px;"></i>
                    <span>Dashboard</span></a>
                @if (Auth::user()->roles_id == 1)
                    <a class="list-group-item d-inline-block text-truncate {{ $title === 'Edit User' ? 'active' : '' }}"
                        href="#!">
                ...
                @elseif(Auth::user()->roles_id == 3)
                    <a class="list-group-item d-inline-block text-truncate {{ $title === 'Presensi' ? 'active' : '' }}"
                        href="#!">
